        ...
        <main className="container mx-auto px-4 py-12 flex flex-col items-center justify-center space-y-24">
          <section className="text-center max-w-3xl">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              Create virtual rooms, sync music across devices, and enjoy a
              shared listening experience with friends in real-time. SyncStream
              brings people together through the power of music.
            </p>
            <Button
              size="lg"
              className="text-lg px-8 py-6 bg-slate-800 hover:bg-slate-700 text-white"
            >
          ...
          <section className="grid md:grid-cols-2 gap-12 w-full max-w-4xl">
              ...
              <ul className="space-y-4 text-gray-600 dark:text-gray-300">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      Generate unique room IDs or links for private listening
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      Experience perfectly synced music across all devices in
                      the room, controlled by the host.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold">
                      Democratic Playlist Management
                    </h4>
                    <p>
                      Vote on songs to influence the play order, ensuring
                      everyone's preferences are considered.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      See who's in the room, what they're voting on, and which
                      songs they're adding to the playlist.
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-8 rounded-lg shadow-lg">
              ...
              <ol className="space-y-4 text-gray-600 dark:text-gray-300">
                <li className="flex items-start">
                  <div className="bg-blue-500 text-white rounded-full w-8 h-8 flex items-center justify-center font-bold mr-3 flex-shrink-0">
                    1
                  </div>
                  <div>
                    <h4 className="font-semibold">Create or Join a Room</h4>
                    <p>
                      Start your own listening session or join an existing one
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      Add your favorite songs to the shared playlist from
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      Upvote or downvote songs to affect their position in the
                      play queue.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>
                      Listen in perfect sync with your friends, no matter where
                      you are.
                    </p>
                  </div>
                </li>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Experience lag-free, perfectly synchronized playback across
                  all devices.
                </p>
              </div>
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Invite friends with a simple link or room code, no complicated
                  setup required.
                </p>
              </div>
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Create password-protected rooms for exclusive listening
                  experiences.
                </p>
              </div>
            </div>
          ...
          <section className="text-center max-w-3xl">
            ...
            <Button
              ...
              className="text-lg px-8 py-6 bg-slate-800 hover:bg-slate-700 text-white"
            >
              <Link href={"/room"}>Create a Room Now</Link>
            </Button>
          </section>
        </main>
      </div>
